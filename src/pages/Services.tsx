...
const services = [
  { name: "CAD Designing", path: "/services/cad-designing" },
  { name: "Rendering", path: "/services/rendering" },
  { name: "Hiphop Work", path: "/services/hiphop-work" },
  { name: "Face Work", path: "/services/face-work" },
  { name: "Manual Designing", path: "/services/manual-designing" },
  { name: "Manufacturing", path: "/services/manufacturing" },
  { name: "File Selling", path: "/services/file-selling" },
];
